...
using GroupDocs.Comparison.UI.Api.Cloud.Storage.ApiConnect;
using GroupDocs.Comparison.UI.Api.Cloud.Storage.ApiConnect.Contracts;
using GroupDocs.Comparison.UI.Api.Cloud.Storage.ApiConnect.Handlers;
...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        public static GroupDocsComparisonUIApiBuilder AddCloudStorage(
            this GroupDocsComparisonUIApiBuilder builder, Action<Config> setupConfig)
        {
            if (setupConfig == null)
