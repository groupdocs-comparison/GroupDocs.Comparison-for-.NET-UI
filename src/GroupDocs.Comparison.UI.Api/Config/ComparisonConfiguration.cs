...
using System.IO;
using System.Linq;
using GroupDocs.Comparison.UI.Api.Util.Parser;
using Newtonsoft.Json;

namespace GroupDocs.Comparison.UI.Api.Config
{
    /// <summary>
    /// CommonConfiguration
    /// </summary>
    public class ComparisonConfiguration : CommonConfiguration
    {
        ...
        public ComparisonConfiguration()
        {
            ...
            {
                filesDirectory = System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, filesDirectory);
            ...
            {
                resultDirectory = System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, resultDirectory);
