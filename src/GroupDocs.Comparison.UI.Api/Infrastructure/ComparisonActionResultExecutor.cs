...
{
    internal class ComparisonActionResultExecutor : ActionResult, IStatusCodeActionResult
    {
        ...
        public async Task ExecuteAsync(ActionContext context, ComparisonActionResult result)
        {
            if (context == null)
            {
